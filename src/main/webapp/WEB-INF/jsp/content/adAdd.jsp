			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						...
						<tr>
						    <td align="right" width="10%">测试<font color="red">*</font>：</td>
							<td width="30%">
								<input id="weight" name="list[0]" value="testvalue1" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="list[1]" value="testvalue2" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="strArray[0]" value="testvalue3" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="strArray[0]" value="testvalue3" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="adList[0].title" value="testvalue4" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="map[key]" value="testvalue5" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="adMap[adkey].title" value="testvalue6" class="allInput" style="width:100%;" type="text"/>
								<input id="weight" name="mydate" value="19900929" class="allInput" style="width:100%;" type="text"/>
							</td>
						</tr>
					  </tbody>
					</table>
