...
public class AdController {
	...
	public String init(Model model, HttpServletRequest request) {
		...
		List<AdDto> searchByPage = adService.searchByPage(adDto);
		Iterator<AdDto> iterator = searchByPage.iterator();
		while(iterator.hasNext()){
			AdDto next = iterator.next();
			next.setMydate(new Date());
		}
		model.addAttribute("list", searchByPage);
